            ...
            <div>
              <ul>
                <li
                  ...
                  class="list-disc flex items-center list-inside font-serif text-sm p-1 "
                >
                  {{ definition.definition }}
                  <span v-if="toggleCopyIcon && hoverIndex === index && hoverPartOfSpeech == partOfSpeech.partOfSpeech" class="px-3">
                    <CopySvg @click="copyDefinitionToClipBoard(definition.definition)" />
                  </span>
                  <span v-if="copiedText && hoverIndex === index && hoverPartOfSpeech === partOfSpeech.partOfSpeech" class="text-[9px] text-gray-600">copied</span>
                </li>
              </ul>
